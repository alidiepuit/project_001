 ...
 */
package comic.ali.com.truyentranh.renderer.rendererbuilder;

import comic.ali.com.truyentranh.renderer.EpisodeRenderer;
import comic.ali.com.truyentranh.viewmodel.EpisodeViewModel;
...
public class EpisodeRendererBuilder extends RendererBuilder<EpisodeViewModel> {
  ...
  public EpisodeRendererBuilder(List<Renderer<EpisodeViewModel>> prototypes) {
    super(prototypes);
  }
